...
function builder(options) {
  ...
  if (!options.network) {
    options.network = squarecore.Networks.defaultNetwork;
  }

  options.Block = options.Block || squarecore.Block;
  options.BlockHeader = options.BlockHeader || squarecore.BlockHeader;
  options.Transaction = options.Transaction || squarecore.Transaction;
  options.MerkleBlock = options.MerkleBlock || squarecore.MerkleBlock;
